...
(function (window) {
  ...
  View.prototype.render = function (viewCmd, parameter) {
    ...
    var viewCommands = {
      ...
      contentBlockVisibility: function () {
        that.$main.style.display = that.$footer.style.display =
  ...
  View.prototype._deleteItemId = function (element) {
    var li = $parent(element, "li");
  ...
  View.prototype.bind = function (event, handler) {
    ...
    if (event === "newTodo") {
      ...
      $live("#delete-item", "click", function () {
        handler(that._deleteItemId(this));
      });
    }
  };
