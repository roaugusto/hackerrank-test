(function (window) {
  ...
  function Controller(model, view) {
    ...
    that.view.bind("deleteItem", function (id) {
      that.removeItem(id);
    });
  }
  ...
  /**
   * An event to fire whenever you want to remove an item. Simply pass the id of the
   * object and it'll handle the DOM and remove the item.
   */
  Controller.prototype.removeItem = function (id) {
    var that = this;

    that.model.removeItem(id, function () {
      that._filter(true);
    });
  };
